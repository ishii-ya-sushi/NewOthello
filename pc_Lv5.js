...
function algorithm5() {
    ...
    } else if (gameRecord2D.length === 5) {

        // setTimeout(function () {
        //     document.querySelector("#scoreBlack3").style.backgroundImage = "url(/images/banpei_you.png)";
        //     document.querySelector("#myCanvas").style.backgroundImage = "url(/images/banpei_uk3.png)";
        //     console.log("巨人兵巨人兵巨人兵巨人兵巨人兵巨人兵巨人兵巨人兵巨人兵巨人兵巨人兵巨人兵");
        // }, 5000);

    } else if (gameRecord2D.length === 13) {
        p_bubble();
    } else if (gameRecord2D.length === 23) {
        p_circle(x, y, "w");
    } else if (gameRecord2D.length === 33) {
        p_fireBall(x, y, "w");
    } else if (gameRecord2D.length === 43) {
        p_commetL(x, y, "w");
    } else if (gameRecord2D.length === 53) {
        p_fireWall(x, y, "w");
    }
