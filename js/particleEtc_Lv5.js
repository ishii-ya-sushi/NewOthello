...
function particleEtc(x, y, attacker) {
  ...
  particleEffectEtc(x, y, attacker, effectName);
}

function particleEffectEtc(x, y, attacker, effectName) {
  // リスナーを全部削除してタイマを止める
  ...
  // 定期的に呼ばれる関数を登録
  createjs.Ticker.addEventListener("tick", handleTick_etc);
}

function handleTick_etc() {
