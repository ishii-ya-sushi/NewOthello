...
function p_circle(x, y, attacker) {
  ...
  p_e_circle(x, y, attacker, effectName);
}

function p_e_circle(x, y, attacker, effectName) {
  // リスナーを全部削除してタイマを止める
  ...
  // 定期的に呼ばれる関数を登録
  createjs.Ticker.addEventListener("tick", handleTick_circle);
}

function handleTick_circle() {
